...
void test_noone_home(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(20, data.input);
    TEST_ASSERT_EQUAL_INT(20, data.output);
    vSemaphoreDelete(request);
    vSemaphoreDelete(response);
}
...
void test_noop(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(0, uxSemaphoreGetCount(response));
    TEST_ASSERT_EQUAL_INT(30, data.input);
    TEST_ASSERT_EQUAL_INT(30, data.output);
    vTaskDelete(coop_thread);
    vSemaphoreDelete(request);
    vSemaphoreDelete(response);
}
...
void test_out_of_order(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(40, data.input);
    TEST_ASSERT_EQUAL_INT(40, data.output);
    vTaskDelete(coop_thread);
    vSemaphoreDelete(request);
    vSemaphoreDelete(response);
}
